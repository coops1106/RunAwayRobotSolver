...
class AttemptCheckerTest extends RunAwayRobotTest {
    ...
    def "test with default attempts"() {
        ...
        1     | new Point(2, 0) | AttemptOutcome.UNABLE_TO_SOLVE | 2
        1     | new Point(1, 1) | AttemptOutcome.OUT_OF_BOUNDS   | -1
        1     | new Point(0, 2) | AttemptOutcome.UNABLE_TO_SOLVE | 2
        ...
        3     | new Point(3, 0) | AttemptOutcome.UNABLE_TO_SOLVE | 3
        3     | new Point(2, 1) | AttemptOutcome.UNABLE_TO_SOLVE | 3
        3     | new Point(1, 2) | AttemptOutcome.UNABLE_TO_SOLVE | 3
        3     | new Point(0, 3) | AttemptOutcome.UNABLE_TO_SOLVE | 3
